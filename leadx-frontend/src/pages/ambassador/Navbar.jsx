        ...
        >
          {user?.profileImage ? (
            <img
              ...
              alt={user.name}
              className="w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover shadow-sm border-2 border-purple-200"
            />
          ) : (
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-full flex items-center justify-center shadow-sm border-2 border-purple-200">
