        ...
        <table className="w-full divide-y divide-slate-200" style={{ minWidth: '800px' }}>
          <thead className="bg-gradient-to-r from-yellow-50 to-orange-50">
            <tr>
              ...
              <th className="px-2 lg:px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider whitespace-nowrap">Email</th>
              <th className="px-2 lg:px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider whitespace-nowrap">Login Time</th>
              <th className="px-2 lg:px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider whitespace-nowrap">IP Address</th>
              <th className="px-2 lg:px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider whitespace-nowrap">Location</th>
              <th className="px-2 lg:px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider whitespace-nowrap">ISP</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-200">
            {logins.map((log) => (
              <tr key={log._id} className="hover:bg-yellow-50/50 transition-colors duration-200">
                ...
                <td className="px-2 lg:px-4 py-4 whitespace-nowrap text-center">
                  <div className="text-sm font-semibold text-slate-900">{log.userId.email || 'N/A'}</div>
                </td>
                <td className="px-2 lg:px-4 py-4 whitespace-nowrap text-center">
                ...
                <td className="px-2 lg:px-4 py-4 whitespace-nowrap text-sm text-slate-900 text-center">
                  <div className="truncate max-w-24">{log.ipAddress || 'N/A'}</div>
                </td>
                <td className="px-2 lg:px-4 py-4 whitespace-nowrap text-sm text-slate-900 text-center">
                  <div className="flex flex-col items-center">
                    <div className="truncate max-w-24">{log.city || 'Unknown'}</div>
                    <div className="text-xs text-slate-500">{log.region || 'Unknown'}</div>
                  </div>
                </td>
                <td className="px-2 lg:px-4 py-4 whitespace-nowrap text-sm text-slate-900 text-center">
                  <div className="truncate max-w-32">{log.isp || 'Unknown'}</div>
                </td>
              </tr>
            ))}
            {logins.length === 0 && (
              <tr>
                <td colSpan="6" className="px-6 py-8 text-center">
                  <div className="flex flex-col items-center">
                    ...
                    <h4 className="text-sm font-medium text-slate-500 mb-1">No Login History Yet</h4>
