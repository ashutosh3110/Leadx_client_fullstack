...
import { ambassadorAPI, customizationAPI } from "../utils/apicopy"
...
const ScriptGeneratorForm = () => {
  ...
  // Load ambassadors and saved configurations
  useEffect(() => {
    loadAmbassadors()
    loadConfigurations()
  }, [])
  ...
  const loadAmbassadors = async () => {
    try {
      ...
      const verifiedAmbassadors = Array.isArray(response?.data)
        ? response.data.filter((u) => u.role === "ambassador" && u.isVerified)
        : []
      setAmbassadors(verifiedAmbassadors)
    } catch (error) {
  ...
  const copyScriptToClipboard = () => {
    const scriptTag = `<script src="${generatedScript}"></script>`
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-4 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="p-6">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                Script Generator & Manager
              </h1>
              <p className="text-slate-600">
                Create embeddable ambassador widgets for your clients
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="https://university.edu (where script will be embedded)"
                      className="w-full p-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        className="flex-1 p-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                      />
                      <input
                        type="color"
                        value={
                    ...
                    <div className="flex items-start space-x-2">
                      <div className="flex-1">
                        <textarea
                          ...
                          rows="2"
                          className="w-full p-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-sm resize-none"
                        />
                      </div>
                      <button
                        type="button"
        ...
        {savedConfigurations.length > 0 && (
          <div className="mt-8 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-slate-200">
            <div className="p-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Copy this script tag and embed it in your client's website:
            </p>
            <div className="bg-gray-100 p-4 rounded-lg mb-4">
              <code className="text-sm break-all">
                {`<script src="${generatedScript}"></script>`}
              </code>
            </div>
